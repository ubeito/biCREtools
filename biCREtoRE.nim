...
# 3. peel usless peripheral strings
  ...
  return newscttkseqs.mapIt(it.simplifyEmpStr.eraseEmpStr).deduplicate.sortedByIt((it[0][1], it[high(it)][1])) #.mapIt(it.toStr)

when isMainModule:
  var ptt = r":>^R[+-]:>^C[0-9]*(\.[0-9]|[0-9]<:_G\.)[0-9]*<:_B" # r":>(0|1)*1(0|1)<:(0|1)<:" # r":>(0?0?<:1)*" # r":>^00:>^10:>^201<:_01<:_11<:_2" #={0001,001,01,00011,0011,011,000111,00111,0111} #
  # r":>(0|1(<:_101*<:_20|11)*1<:_30)*<:_0" #=>@[":>(0|1(01*0|11)*10)*<:_0", ":>(0|1(01*0|11)*10)*1(01*0|11)*01*<:_2", ":>(0|1(01*0|11)*10)*1(01*0|11)*<:_1", ":>(0|1(01*0|11)*10)*1(01*0|11)*1<:_3"] # Example 8
  # r":>((0|(0|1<:_B0)(000<:_B0)*001)(<:_R1(0<:_G00<:_B0)*0<:_G01)*<:_R0)*(0|1<:_B0)(000<:_B0)*0<:_G" # Example 1 CFA in first IEICE paper =>
  #0: ":>((0|(0|10)(0000)*001)(1(0000)*001)*0)*(0|10)(0000)*000<:_B"
  #1: ":>((0|(0|10)(0000)*001)(1(0000)*001)*0)*1<:_B"
  #2: ":>((0|(0|10)(0000)*001)(1(0000)*001)*0)*(0|(0|10)(0000)*001)(1(0000)*001)*1(0000)*000<:_B"
  #3: ":>((0|(0|10)(0000)*001)(1(0000)*001)*0)*(0|(0|10)(0000)*001)(1(0000)*001)*1(0000)*0<:_G"
  #4: ":>((0|(0|10)(0000)*001)(1(0000)*001)*0)*(0|10)(0000)*0<:_G"
  #5: ":>((0|(0|10)(0000)*001)(1(0000)*001)*0)*(0|(0|10)(0000)*001)(1(0000)*001)*<:_R"
  ...
  # r"(a:>b)*c(d<:e)*" # r"f(a(b:>c)*d<:e)*g" # r":>a(:>b<:)*"#=>@[":>a(b)*b<:", ":>b<:", ":>b(b)*b<:"] # r":>((a<:b)*c)*"#=>":>((ab)*c)*(ab)*a<:" # r"(:><:)*"#=> @[":><:", ":>([])*<:"]
  # r":>*<:*"#=>":><:" # r":><:*"#=>":><:" # r":>*<:"#=>":><:" # r"(<::>)*"#=>":>([])*<:" # r"(<:|:>)*"#=>":>([]|)*<:" # r"(0<::>1)*"#=>":>1(01)*0<:" # r"(0:><:1)*"#=>@[":><:", ":>1(01)*0<:"] # r"(0*<:2:>1*)*"#=>":>1*(0*21*)*0*<:" # r":>(0:><:1)*<:"#=>@[":><:", ":>1(01)*0<:", ":>1(01)*<:", ":>(01)*0<:", ":>(01)*<:"] # r":>a(:>b<:)*" # 
  # r"a|b(c|d(e:>|f(<:g)*)*)*" # ==> @[":>(e|f(g)*)*f(g)*<:", ":>(e|f(g)*)*(c|d(e|f(g)*)*)*d(e|f(g)*)*f(g)*<:"]
